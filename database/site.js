...
const site = new Schema({
    site: {
        ...
        text: {
            terms: { type: String, default: '<h2>Kullanım Koşulları</h2> Lütfen sitemiz.com dan hizmet satın almadan önce aşağıdaki koşulları dikkatlice okuyun. sitemiz.com a kayıt olup, hizmetlerini kullanarak tüm koşulları okuduğunuzu, anladığınızı ve kabul ettiğinizi beyan edersiniz. Bu hüküm ve koşulları kabul etmiyorsanız lütfen sitemiz.com hizmetlerini kullanmayın. <br> <h2>Genel Şartlar</h2> ● Varsayılan minimum ödeme tutarı 10TLdir. <br> ● sitemiz.com servis fiyatlarını önceden haber vermeksizin herhangi bir zamanda değiştirebilir. Ödeme / Geri Ödeme politikası sabit kalır. <br> ● sitemiz.com herhangi bir hizmet için teslimat süresini garanti etmez. Servislerde yazılı olan başlama süreleri belirttimiz en yakın tahminlerdir. <br> ● 1 Link için aynı anda sadece 1 sipariş girilebilir, 2 sipariş birden girildiğinde eksik gönderimler olabilir, sorumlusu sitemiz.com değildir. <br> ● sitemiz.com Instagram, Facebook, Twitter veya sunduğu herhangi bir hizmet için, işlem yapılan hesabın askıya alınması, kapatılması gibi olası durumlarda mesuliyet kabul etmez. <br> ● Kullanmakta olduğunuz web sitesi üzerinden elektronik ortamda sipariş verdiğiniz takdirde, size sunulan ön bilgilendirme formunu ve mesafeli satış sözleşmesini kabul etmiş sayılırsınız. <br> ● Tüm sistem üyelerine e-mail ve cep telefonuna çok sık olmamak kaydı ile sistemimiz hakkında bilgilendirici mesajlar gönderilebilir. Sisteme üye olarak tarafımıza iletişim hakkı vermiş olursunuz. <br> ● Her servise verilen limit, hesap başına verilen limittir. Max 3k limitli bir servisten yararlanan hesap 4k çekim yapamaz. <br> ● Ürünlerin karşılarında belirtilen ücretler 1.000 (1K) ücretidir. <br> ● sitemiz.com Tarafından sisteme kayıt olan her kullanıcının telefon numarasına istenildiği zaman mesaj gönderme hakkına sahiptir. <br> <h2>Hizmet Şartları</h2> ● sitemiz.com İnstagram/Twitter/Facebook veya başka bir Sosyal Medya hesabı için sadece "Görünüm" artırmaya yardımcı olmak için kullanılacaktır. <br> ● sitemiz.com yeni takipçiler ve etkileşim garantisi vermez, sadece ödeme yapılarak alınan miktarı garanti eder. <br> ● Tüm bot hesapları gerçek görünüme dönüştürmek için çalışıyoruz, ancak hesaplarımızın %100 profil resimli, biyografili ve paylaşımlı hesaplar olacağının garantisini vermiyoruz. <br> ● Gizli hesaplara işlem yapıldığında sorumluluk üyeye aittir. Sipariş vermeden önce lütfen hesabın herkese açık olduğundan emin olun. <br> <h2>İade Şartları</h2> ● Yapılan ödemelerde geri iade mümkün değildir, sitemiz.com hizmetlerinde kullanılması gerekir. <br> ● Instagram/Twitter/Facebook vb. servislerin ne zaman güncelleme yapabileceğini bilemeyiz, herhangi bir düşüş yaşanması halinde servis sağlayıcısı telafi yapmadığı sürece iade yapılamaz. <br> ● Siparişler sisteme girildikten sonra iptal/iade talebiniz kabul edilmeyecektir. Eğer sipariş tamamlanmazsa/kısmen tamamlanırsa sistem otomatik olarak geri ödeme yapacaktır. <br> ● sitemiz.com yapılan ödemelerde herhangi bir ters ibraz, geri çekme söz konusu olursa üyeyi uzaklaştırma hakkını saklı tutar. <br> ● Yetkisiz işlem veya çalıntı kredi kartı, herhangi bir hileli faliyette üye hesabı istisnasız kapatılacaktır. <br> <h2>Gizlilik Politikası</h2> ● Bu politika kişisel bilgilerinizin nasıl kullanacağını kapsar. Gizliliğiniz bizim için önemlidir ve korumak için her türlü önlem alınmaktadır. <br> ● Sisteme girilen tüm bilgiler şifreli ve güvenli sunucularda barındırılır. <br> ● Bilgileriniz hiçbir şekilde 3. kişiler ile paylaşılmaz. sitemiz.com bildirimde bulunmaksızın Hizmet Şartlarını değiştirme hakkını saklı tutar <h1>Kullanım Sözleşmesi</h1> Lütfen sitemiz.comdan hizmet satın almadan önce aşağıdaki koşulları dikkatlice okuyun. sitemiz.coma kayıt olup, hizmetlerini kullanarak tüm koşulları okuduğunuzu, anladığınızı ve kabul ettiğinizi beyan edersiniz. Bu hüküm ve koşulları kabul etmiyorsanız lütfen sitemiz.com hizmetlerini kullanmayın. <h3>1. Genel</h3> ● sitemiz.comdan aldığınız tüm hizmetlerin sorumluluğu size aittir.<br> ● TAKİPÇİ ATILIMI SONRASI PROFİLDE OLUŞACAK KAPANMA VEYA DÜŞÜŞLERDEN sitemiz.com SORUMLU DEĞİLDİR.<br> ● Varsayılan minimum ödeme tutarı 5TLdir.<br> ● sitemiz.com servis fiyatlarını önceden haber vermeksizin herhangi bir zamanda değiştirebilir. Ödeme / Geri Ödeme politikası sabit kalır.<br> ● sitemiz.com herhangi bir hizmet için teslimat süresini garanti etmez. Servislerde yazılı olan başlama süreleri belirttimiz en yakın tahminlerdir.<br> ● 1 Link için aynı anda sadece 1 sipariş girilebilir, 2 sipariş birden girildiğinde eksik gönderimler olabilir, sorumlusu sitemiz.com değildir.<br> ● sitemiz.com Instagram, Facebook, Twitter veya sunduğu herhangi bir hizmet için, işlem yapılan hesabın askıya alınması, kapatılması gibi olası durumlarda mesuliyet kabul etmez.<br> ● Tüm sistem üyelerine e-mail ve cep telefonuna çok sık olmamak kaydı ile sistemimiz hakkında bilgilendirici mesajlar gönderilebilir. Sisteme üye olarak tarafımıza iletişim hakkı vermiş olursunuz.<br> ● Her servise verilen limit, hesap başına verilen limittir. Max 3k limitli bir servisten yararlanan hesap 4k çekim yapamaz.<br> ● Ürünlerin karşılarında belirtilen ücretler 1.000 (1K) ücretidir.<br> ● Garantili servislerde servis kapanır veya sağlayıcıya ulaşılamaması gibi durumlarda telafi sorumluluğu kesinlikle tarafımıza ait değildir.<br> <h3>2. Hizmet</h3> ● sitemiz.com İnstagram/Twitter/Facebook veya başka bir Sosyal Medya hesabı için sadece "Görünüm" artırmaya yardımcı olmak için kullanılacaktır.<br> ● sitemiz.com yeni takipçiler ve etkileşim garantisi vermez, sadece ödeme yapılarak alınan miktarı garanti eder.<br> ● Tüm bot hesapları gerçek görünüme dönüştürmek için çalışıyoruz, ancak hesaplarımızın %100 profil resimli, biyografili ve paylaşımlı hesaplar olacağının garantisini vermiyoruz.<br> ● Gizli hesaplara işlem yapıldığında sorumluluk üyeye aittir. Sipariş vermeden önce lütfen hesabın herkese açık olduğundan emin olun.<br> ● Siparişlerin tamamlanması 48 - 72 saati bulabilir. (bu süre duruma göre uzayabilir ve kısalabilir.)<br> ● Garantili servislerde servis kapanır veya sağlayıcıya ulaşılamaması gibi durumlarda telafi sorumluluğu kesinlikle tarafımıza ait değildir.<br>' }, // Kullanım koşulları  
            invite: {
        ...
        number: {
            ...
            sender: {
                ...
                header: { type: String, default: 'NovaPanel' }, // başlık en az 3 en fazla 11 karakter olmalı marka adı olabilir
            }
        },
        mail: {
            status: { type: Boolean, default: false }, // Mail doğrulama açık mı?
            title: { type: String, default: 'NovaPanel - Hoş Geldiniz!' }, // Mail başlığı
        ...
        integrations: { // Entegrasyonlar
            seo: {
                name: { type: String, default: 'NovaPanel' },
                url: { type: String, default: config.siteUrl },
                description: { type: String, default: 'NovaPanel' },
                keywords: { type: String, default: 'NovaPanel, smm, smmpanel, panel' },
            },
            googleAnalytics: {
